...
CREATE TABLE IF NOT EXISTS public.outfit_recommendations_p0 PARTITION OF public.outfit_recommendations FOR
VALUES
    WITH (MODULUS 2, REMAINDER 0);

CREATE TABLE IF NOT EXISTS public.outfit_recommendations_p1 PARTITION OF public.outfit_recommendations FOR
VALUES
...
-- Enable RLS
ALTER TABLE
    public.waitlist_archive ENABLE ROW LEVEL SECURITY;
...
DO $$ BEGIN IF NOT EXISTS (
    ...
    FROM
        pg_policies
    WHERE
        tablename = 'outfit_recommendations'
        AND policyname = 'Users can view own recommendations'
) THEN CREATE POLICY "Users can view own recommendations" ON public.outfit_recommendations FOR
SELECT
    USING (
        (
            select
...
) THEN CREATE POLICY "Users can insert own recommendations" ON public.outfit_recommendations FOR
INSERT
    WITH CHECK (
        (
            select
...
) THEN CREATE POLICY "Users can view own errors" ON public.error_logs FOR
SELECT
    USING (
        (
            select
...
-- Seed waitlist data
INSERT INTO
    public.waitlist_archive (id, email, created_at, status, referred_by)
VALUES
    (
        '69d2a4c0-13d5-4ca2-acb0-bb9c13f75e7b',
        'w.ruzindana@alustudent.com',
        '2025-05-26 13:30:54.673377+00',
        'pending',
        NULL
    ),
    (
        '46c396a9-b139-474a-ac86-8cf13acb6b93',
        'davidwampamba@gmail.com',
        '2025-05-26 16:31:02.651569+00',
        'pending',
        NULL
    ),
    (
        '69d35f19-934c-48f1-b298-9d9a7d23334a',
        'tetagata@yahoo.fr',
        '2025-05-28 10:37:33.778656+00',
        'pending',
        NULL
