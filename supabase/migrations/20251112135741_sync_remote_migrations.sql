...
drop policy "Users can insert own wear history" on "public"."wear_history";

drop policy "Users can update own wear history" on "public"."wear_history";

drop policy "Users can view own wear history" on "public"."wear_history";
...
revoke delete on table "public"."wear_history" from "anon";

revoke insert on table "public"."wear_history" from "anon";

revoke references on table "public"."wear_history" from "anon";

revoke select on table "public"."wear_history" from "anon";

revoke trigger on table "public"."wear_history" from "anon";

revoke truncate on table "public"."wear_history" from "anon";

revoke update on table "public"."wear_history" from "anon";

revoke delete on table "public"."wear_history" from "authenticated";

revoke insert on table "public"."wear_history" from "authenticated";

revoke references on table "public"."wear_history" from "authenticated";

revoke select on table "public"."wear_history" from "authenticated";

revoke trigger on table "public"."wear_history" from "authenticated";

revoke truncate on table "public"."wear_history" from "authenticated";

revoke update on table "public"."wear_history" from "authenticated";

revoke delete on table "public"."wear_history" from "service_role";

revoke insert on table "public"."wear_history" from "service_role";

revoke references on table "public"."wear_history" from "service_role";

revoke select on table "public"."wear_history" from "service_role";

revoke trigger on table "public"."wear_history" from "service_role";

revoke truncate on table "public"."wear_history" from "service_role";

revoke update on table "public"."wear_history" from "service_role";

alter table "public"."wear_history" drop constraint "check_wear_target";

alter table "public"."wear_history" drop constraint "wear_history_comfort_rating_check";

alter table "public"."wear_history" drop constraint "wear_history_confidence_rating_check";

alter table "public"."wear_history" drop constraint "wear_history_outfit_id_fkey";

alter table "public"."wear_history" drop constraint "wear_history_user_id_fkey";

drop index if exists "public"."idx_user_wardrobe_analytics_user_id";
...
drop function if exists "public"."get_item_wear_history"(p_item_id uuid, p_limit integer);
...
drop function if exists "public"."mark_item_worn"(p_item_id uuid, p_worn_date date, p_occasion text, p_notes text);

drop function if exists "public"."mark_outfit_worn"(p_outfit_id uuid, p_worn_date date, p_occasion text, p_notes text, p_event_id uuid);

drop function if exists "public"."sync_trends"();

drop function if exists "public"."update_trend_scores"();

drop function if exists "public"."update_wear_counts"();

drop materialized view if exists "public"."user_wardrobe_analytics";

alter table "public"."wear_history" drop constraint "wear_history_pkey";

drop index if exists "public"."idx_wear_history_event";

drop index if exists "public"."idx_wear_history_item";

drop index if exists "public"."idx_wear_history_outfit";

drop index if exists "public"."idx_wear_history_user_date";

drop index if exists "public"."wear_history_pkey";

drop table "public"."wear_history";
            ...
            SELECT jsonb_agg(
                jsonb_build_object(
                    ...
                    'subcategories', (
                        ...
                        WHERE cs.category_id = cc.id AND cs.is_active = TRUE
                    )
                )
            )
...
BEGIN
    IF EXISTS (
        ...
        AND (
            ...
            similarity(lower(name), lower(NEW.name)) > 0.6
        )
    ) THEN
...
create policy "Service role can update seasonal trends"
on "public"."seasonal_trends"
as permissive
for update
to public
