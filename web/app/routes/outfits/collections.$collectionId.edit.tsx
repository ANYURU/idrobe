...
export default function EditCollectionPage({ actionData, loaderData, params }: Route.ComponentProps) {
...
function EditForm({ collectionPromise, itemsPromise, selectedItems, setSelectedItems, onSubmit }: {
