import { useSeasonalTrends } from '@/lib/hooks'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { Badge } from '@/components/ui/badge'
import { Sparkles } from 'lucide-react'

export default function TrendsPage() {
  const { trends, loading } = useSeasonalTrends()
                ...
                <CardContent className="space-y-4">
                  ...
                  {trend.trending_colors && trend.trending_colors.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {trend.trending_colors.map((color) => (
                  ...
                  {trend.trending_patterns && trend.trending_patterns.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {trend.trending_patterns.map((pattern) => (
                  ...
                  {trend.trending_styles && trend.trending_styles.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {trend.trending_styles.map((style) => (
