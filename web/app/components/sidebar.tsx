...
export function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "bg-sidebar border-r border-sidebar-border h-screen flex flex-col overflow-hidden",
      ...
      >
        <header className="hidden md:flex items-center h-16 px-6 border-b border-sidebar-border shrink-0">
          <Logo />
        </header>
